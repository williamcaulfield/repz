...
export default {
  ...
  methods: {
    ...
    renameWorkoutPlan(newWorkoutName) {
    ...
    updateMusclesUsed() {
      while (this.musclesUsed.length) {
        this.musclesUsed.pop();
      }

      this.exercisesPlanned.forEach(function (item, index) {
        item.musclesUsed.forEach(function (muscle) {
          if (!this.selectedItems.indexOf(muscle)) {
            this.musclesUsed.push(muscle);
          }
        });
      });
  ...
  data() {
    return {
      ...
      workoutPlanDetail: {
        ...
        timeStart: "2016-06-01T12:50:53.941+0200",
        timeEnd: "2016-06-01T12:59:53.941+0200",
        timeEstimatedCompleted: 43,
