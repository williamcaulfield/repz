  ...
  <StackLayout class="workoutPage" verticalAlignment="top">
    <GridLayout rows="auto,auto,auto,auto,auto,auto,auto,auto,*" columns="*">
      ...
      <GridLayout
        ...
        horizontalAlignment="center"
        marginTop="-18"
        v-show="exercise.isCompleted == false"
      >
        <Image
          row="4"
          col="2"
        ...
        >
          <Label
            col="0"
            row="0"
            :text="exercise.completedCount"
            class="workoutrecord--heading -h0 -default"
            marginTop="-20"
            horizontalAlignment="center"
          />
          <Label
      ...
      >
        ...
        <Label
          col="1"
          :text="' of ' + exercise.exerciseTargetCount"
        ...
        <Label
          col="2"
          :text="exercise.exerciseTargetCount"
          class="workoutrecord--heading -h3 -primary"
          height="10%"
      ...
      <Label
        ...
        height="10%"
        horizontalAlignment="center"
        v-show="exercise.isCompleted == true && targetAchieved == true"
      />
      <Label
        row="7"
        text="Rest day is it?"
        ...
        height="10%"
        horizontalAlignment="center"
        v-show="exercise.isCompleted == true && targetAchieved == false"
      />
      <GridLayout
        row="5"
        col="1"
      ...
      >
        ...
        <Label
          row="0"
          col="2"
          :text="'+' + exercise.weightExtra + 'Kg'"
          class="workoutrecord--heading -h4 -primary"
          height="10%"
          horizontalAlignment="center"
        />
      </GridLayout>
      ...
      >
        <GridLayout
          rows="*"
          columns="*,auto,auto,*"
          @tap="showExercise(exercise.exerciseID)"
        >
          <Image
